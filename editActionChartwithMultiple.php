    	...
    	<div class="widget">
            ...
            <div class="widget_body">
                ...
                <ul class="form_fields_container">
            		...
            		<li><label>Sercon Lead number : *</label> <div class="form_input"><input type="text" readonly="readonly"  value="<?php echo $completeLeadNumber; ?>" ></div></li>
...
return true;
                    ...
                    <li>
                        ...
                        <div class="form_input"><input name="stage" id="stage" type="radio" value="Lead" <?php if($stage == "Lead"){echo "checked=checked";} ?>>
                        <label for="radio1">Lead</label> </div>
                        <div class="form_input"><input id="stage" name="stage" type="radio" value="Execution" <?php if($stage == "Execution"){echo "checked=checked";} ?>>
                        <label for="radio1">Execution</label></div>
                         <div class="form_input"><input id="stage" name="stage" type="radio" value="Invoice" <?php if($stage == "Invoice"){echo "checked=checked";} ?>>
                        <label for="radio1">Invoice</label></div>
                    </li>
                    
                    <li>
                    	<label>Key Account :</label> 
                        <div class="form_input"><input name="key" type="radio" id="key3" value="Yes" onClick="selectkey1()" <?php if($keyAccount == "Yes"){echo "checked=checked";} ?>>
                        <label for="radio1">Yes</label> </div>
                        <div class="form_input"><input name="key" type="radio" id="key" value="No" onClick="selectkey2()" <?php if($keyAccount == "No"){echo "checked=checked";} ?>>
						...
						if($keyact == $id){$che = "Selected = Selected";}
						else
						{$che = "";}
                    ...
                    <select name="city" id="city">
						...
						if($city == $city_name){$che_city = "Selected = Selected";}
						else
						{$che_city = "";}
...
return true;
                     ...
                     <li>
                    	<label>Type :*</label> 
                        <div class="form_input"><input id="radio1" name="eventtype" type="radio" value="Single" onClick="select4()" <?php if($type == "Single"){echo "checked = checked";} ?> >
                        <label for="radio1">Single Day</label> </div>
                        <div class="form_input"><input id="radio1" type="radio" name="eventtype" value="Multi" onClick="select5()" <?php if($type == "Multi"){echo "checked = checked";} ?>>
                        <label for="radio1">Multi-Day</label></div>
                    </li>
                    
                    <li><label>Date :<br/><span style="font-size:9px;">(Data required by : <br/>Database & Creatives)</span></label> <div class="form_input"><input type="text" name="dateevent" id="datepicker" class="tip_east" title="Date" value="<?php echo $eventDate; ?>"><span style="font-size:9px;">(Click 
                    ...
                    <select name="name" id="name">
						...
						if($projectLeader == $user_id){$che_pro = "Selected = Selected";}
						else{$che_pro = "";}
...
cntfield.value = maxlimit - field.value.length;
                    ...
                    <div class="form_input"><select name="bdname" class="select" id="select4" onChange="selectid(this)">
						...
						if($bdId == $user_id){$che_bd = "Selected = selected";}
						else
						{$che_bd = "";}
                    ...
                    <li>
                    	<label>Status :*</label> 
                        <div class="form_input"><input id="radio1" name="status" value="green" type="radio" <?php if($status == "green"){echo "checked = checked";} ?>>
                        <label for="radio1"><span class="color" style="background:#060;">Green</span></label> </div>
                        <div class="form_input"><input id="radio1" name="status" value="yellow" type="radio" <?php if($status == "yellow"){echo "checked = checked";} ?>>
                        <label for="radio1"><span class="color" style="background:#FF0; color:#000">Yellow</span></label></div>
                         <div class="form_input"><input id="radio1" type="radio" name="status" value="red" <?php if($status == "red"){echo "checked = checked";} ?>>
