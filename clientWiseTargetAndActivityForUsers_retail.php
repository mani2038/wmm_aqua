...
if(function_exists('date_default_timezone_set')) date_default_timezone_set($timezone);
                        ...
                        $SelQuery1 = "SELECT * FROM oxy2_clientn_retail ".$getCombinedFunctionResult;
						...
						while($SelResult1 = mysql_fetch_array($SelExec1))
                        {
  ...
  <tr>
    ...
    <td width="23%"><h5>Total Number of Client : <?php echo getClientCount(); ?></h5></td>
          ...
          <div class="widget_body">
          					...
          					<?php if(!empty($getCombinedFunctionResult)){ ?>

                            <div align="right">
                            <a <?php if($_REQUEST['type'] == "p"){ ?>style="margin:5px; border:3px solid gray;"<?php } else {?>style="margin:5px;" <?php } ?> class="yellowBtn button_small" href="./?id=2&subId=17&type=p">Pessimistic Target</a> 
                             <a <?php if($_REQUEST['type'] == "r"){ ?>style="margin:5px; border:3px solid gray;"<?php } else {?>style="margin:5px;" <?php } ?> class="yellowBtn button_small" href="./?id=2&subId=17&type=r">Realistic Target</a>
                              <a <?php if($_REQUEST['type'] == "o"){ ?>style="margin:5px; border:3px solid gray;"<?php } else {?>style="margin:5px;" <?php } ?> class="yellowBtn button_small" href="./?id=2&subId=17&type=o">Optimistic Target</a>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="jqtable">
                        <thead>
                         ...
                         <tr>
                            ...
                            <tr>
                              <th width="140">Client Name</th>
                              <th width="65">Annual GP Target</th>
                              <th width="65">YTD Target</th>
                              <th width="65">YTD Accural</th>
                              <th width="65">YTD Ach</th>
                              <th width="65">YTD Credit</th>
                              <th width="70">YTD %</th>
                              <th width="32">PLN Credit</th>
                              <th width="33">PCM(<?php echo date("M"); ?>)</th>
                              <th width="80">Performance GAP</th>
                              <th width="80">Pipeline GAP</th>
                              <th width="30">---</th>
                            </tr>
                        </thead>
                        <tbody>
...
$SelQuery = "SELECT * FROM oxy2_clientn_retail ".$getCombinedFunctionResult;
...
?>                         
                      ...
                      <td align="center"><span ><?php echo getYTD($type,$clientId,12); ?></span></td>
                     ...
                     <td align="center"><?php echo getpnl($clientId); ?></td>
                     ...
                     <td align="center"><?php echo getPipelineGap($type,$clientId,$systemMonthInDigit);?></td>
                      <td align="center"><span class="data_actions iconsweet"><a class="tip_north" original-title="View" href="./?id=2&subId=7&clientID=<?php echo $clientId; ?> " style="color:#6C6C6C;padding:0 2px;font-size:18px;" target="_blank">}</a>					</span></td>
                            </tr>
...
<?php } }
                ...
                <?php } ?> 
              				...
              				<?php } else { echo "You don't have the right to view this section";  } ?>
