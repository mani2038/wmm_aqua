...
$uploadDir = '/aqua/fivefy/usr_chart_op/';

// auto directory path is showing till www....

// Set the allowed file extensions
$fileTypes = array('jpg', 'jpeg', 'gif', 'png', 'pdf', 'ppt', 'pptx', 'mp4','xlsx','docx','doc'); // Allowed file extensions
...
$resultt = mysqli_fetch_array($res9,MYSQLI_ASSOC);
...
//mssql_select_db ("sercon", $conn);
	...
	if($path == "kbs")
	{
		...
		$res_u=mysqli_query($con,$que_u);
		while($row_u=mysqli_fetch_array($con,$res_u))
		{
		$totalU = $row_u['username'];	
