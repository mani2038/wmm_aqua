    ...
    <h5>View Leads</h5>
          ...
          <div class="widget_body">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="jqtable">
                        <thead>
                            <tr>
                                <th width="46" align="left">Client Name</th>
                              <th width="38">Lead No.</th>
                              <th width="80">Department</th>
                              <th width="84">Lead Name</th>
                              <th width="122">PCD</th>
                              <th width="172">Lead Status</th>
                              <th width="119">Pro. Revenue</th>
                              <th width="161">Created </th>
...
$SelQuery = "SELECT * FROM oxy2_lead WHERE companyname = '$ClientId'";
...
?>                         
                      ...
                      <td align="center"><span ><?php echo $leadno; ?></span></td>
                    ...
                    <a href="viewLeadInvoice.php?ldId=<?php echo $leadId; ?>" id="gallery_box" style="text-decoration:none; font-weight:bold;">[<?php echo getTotalInvoiceByLeadANDCompanyId($leadId,$companyname); ?>]</a>
                    <br/>
                     <span style="font-size:11px; color:#333">[<?php echo getInvoicedGPForLead($leadId); ?>]</span>
                    ...
                    <a href="viewLeadCon.php?ldId=<?php echo $leadId; ?>" id="gallery_box" style="text-decoration:none; font-weight:bold;"><span class="data_actions iconsweet" style="font-size:18px; color:#333">H</span></a>                   
                     ...
                     <td align="center"><?php echo $creator."<br/>".$reg_time; ?></td>
                      <td align="center"><span class="data_actions iconsweet"><a class="tip_north" original-title="View" href="./?id=2&subId=13&ldnumber=<?php echo $leadno; ?>&dep=<?php echo $dept;?> " style="color:#6C6C6C;padding:0 2px;font-size:18px;">}</a> 
                      
                      <?php if($userTypeForLooggedIn == "1" || $userTypeForLooggedIn == "3" || $userTypeForLooggedIn == "6"){ ?> 
	                     <a class="tip_north" original-title="Edit" href="./?id=2&subId=15&ldId=<?php echo $leadId;?>"  style="color:#6C6C6C;padding:0 2px;font-size:18px;">C</a> 
    					<?php } ?>  
