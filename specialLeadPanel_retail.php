...
<?php
$SelQuery = "SELECT * FROM oxy2_lead_retail WHERE leadStatus = '4'";
...
?>                         
                      ...
                      <td align="center"><span ><?php echo $leadno; ?></span><span style=" color:#F00;font-size:9px; position:relative;top:-11px;">AC(<?php echo getCountForLead_retail($leadno,$dept); ?>)</span></td>
                    ...
                    <a href="viewLeadCon.php?ldId=<?php echo $leadId; ?>" id="gallery_box" style="text-decoration:none; font-weight:bold;"><span class="data_actions iconsweet" style="font-size:18px; color:#333">H</span></a>                   
                     ...
                     <td align="center"><?php echo $creator."<br/>".$reg_time; ?></td>
                      ...
                      <a href="confirmLeadDeletionPage.php?leadId=<?php echo $lid; ?>" class="tip_north" id="gallery_box" original-title="Delete Lead" style="color:#F00;padding:0 1px;font-size:18px;">X</a>
                      </span></td>
                            </tr>
