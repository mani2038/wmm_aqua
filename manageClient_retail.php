...
<!--One_Wrap-->
  ...
  <tr>
    <td width="77%"><span class="iconsweet">f</span><h5>View Client wise Target</h5></td>
    <td width="23%"><h5>Total Number of Records : <?php echo getClientCount(); ?></h5></td>
          ...
          <div class="widget_body">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="jqtable">
                        <thead>
                            <tr>
                                <th width="59" align="left">Client Name</th>
                              <th width="65">AD</th>
                              <th width="72">Contact Name</th>
