                ...
                <div class="demo_jui">  
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="jqtable">
                        ...
                        <tbody>
                            ...
                            $yearNumber = date('Y');
                            $SelQuery = "SELECT * FROM oxy2_action WHERE userId	 = '$userIdforAction' AND year(dateAdded) = $yearNumber ORDER BY id DESC";
                            ...
                            if ($cntt > 0) {
                                ...
                                while ($SelResult = mysqli_fetch_array($SelExec)) {
                                    ...
                                    if ($status == "red") {
                                        ...
                                        $col1 = "yellow_highlight";
                                    } else {
                                        $col1 = "green_highlight";
                                    }
                                    ...
                                    <tr class="<?php echo $col; ?>">
                                        ...
                                        <td align="center"><span class="data_actions iconsweet">
                                                ...
                                                <?php if (getTotalop($actionChartId) > 0) {
                                                    ?>                         
                                                    <a href="viewop.php?ldId=<?php echo $actionChartId; ?>" class="tip_north" id="gallery_box" original-title="Upload Event Checklist" style="color:#6C6C6C;padding:0 1px;font-size:18px;"><i class="fa fa-upload" aria-hidden="true"></i></a>
                                                <?php
                                                } else {
                                                    ?>
                                                    <a href="viewop.php?ldId=<?php echo $actionChartId; ?>" class="tip_north" id="gallery_box" original-title="Upload Event Checklist" style="color:#F00;padding:0 1px;font-size:18px;"><i class="fa fa-upload" aria-hidden="true"></i></a>
                                                <?php } ?> 
