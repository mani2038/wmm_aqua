...
if($cntt > 0){
				...
				$paydaterece = $SelResult['paydaterece'];
				$exppaydate = $SelResult['exppaydate'];
				$bdstatus = $SelResult['bdstatus'];
				$project_esti_number = $SelResult['project_esti_number'];
				$curr = $SelResult['curr'];
				...
				$gst_percentage = $SelResult['gst_per'];
        ...
        $agency_fee_amount = $SelResult['agency_fee_amount'];
        $hotel_fee_amount = $SelResult['hotel_fee_amount'];
        $giveaway_fee_amount = $SelResult['giveaway_fee_amount'];
        $estimation_number = $SelResult['estimation_number'];
...
<!--One_Wrap-->
  ...
  <tr>
    <td><h2>WMM / <?php echo $Dep; ?> / <?php echo $ldNum; ?></h2></td>
    <td align="right">
    
      <img src="barcode.php?code=WMM/<?php echo $Dep; ?>/<?php echo $ldNum; ?>" /></td>
  </tr>
</table>
  ...
  <tr>
    <td>   <table width="100%" border="0" cellspacing="3" cellpadding="3" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:14px">
                            ...
                            <table width="100%" border="0" cellspacing="3" cellpadding="3" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:14px">
                                  <tr>
                                    <td colspan="2"><h3>Project Estimate Details</h3>
                                    <hr/>
                                    </td>
                                  </tr>
								  <tr>
                                    <td width="34%">Date Received</td>
                                    <td width="66%"><?php echo $paydaterece; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">Status</td>
                                    <td width="66%"><?php echo $bdstatus; ?></td>
                                  </tr>
                                   <tr>
                                    <td width="34%">Estimation Number</td>
                                    <td width="66%"><?php echo $estimation_number; ?></td>
                                  </tr>
								  <!-- <tr>
                                    <td width="34%">Project Estimate Number</td>
                                    <td width="66%"><?php echo $project_esti_number; ?></td>
                                  </tr> -->
								  <tr>
                                    <td width="34%">Currency</td>
                                    <td width="66%"><?php echo $curr; ?></td>
                                  </tr><tr>
                                    <td width="34%">Total Estimate Amount</td>
                                    <td width="66%"><?php echo $total_esti_amount; ?></td>
                                  </tr><tr>
                                    <td width="34%">Project Fee Amount</td>
                                    <td width="66%"><?php echo $project_fee_amount; ?></td>
                                  </tr>
                                  <tr>
                                    <td width="34%">Agency Fee Amount</td>
                                    <td width="66%"><?php echo $agency_fee_amount; ?></td>
                                  </tr>
                                  <tr>
                                    <td width="34%">Hotel Fee Amount</td>
                                    <td width="66%"><?php echo $hotel_fee_amount; ?></td>
                                  </tr>
                                  <tr>
                                    <td width="34%">Giveaway Fee Amount</td>
                                    <td width="66%"><?php echo $giveaway_fee_amount; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">Sub Total</td>
                                    <td width="66%"><?php echo $sub_total; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">GST(%)</td>
                                    <td width="66%"><?php echo $gst_percentage; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">GST Amount</td>
                                    <td width="66%"><?php echo $gst_amount; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">Grand Total Amount</td>
                                    <td width="66%"><?php echo $grand_amount_total; ?></td>
                                  </tr>
								  <?php if($bdstatus != "Proposal"){ ?>
								  </table>
                            <br/>
							<table width="100%" border="0" cellspacing="3" cellpadding="3" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:14px"> 
								 
                                  <tr>
                                    <td colspan="2"><h3>Pre Event P&L details</h3>
                                    <hr/>
                                    </td>
                                  </tr>
								  <tr>
                                    <td width="34%">Expenses </td>
                                    <td width="66%"><?php echo @$expenses ; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">Projected P&L Amount </td>
                                    <td width="66%"><?php echo @$project_pl_amount; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">P & L(%)</td>
                                    <td width="66%"><?php echo $pl_percentage?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">Client PO Number</td>
                                    <td width="66%"><?php echo @$client_po_number; ?></td>
                                  </tr><tr>
                                    <td width="34%">PO value</td>
                                    <td width="66%"><?php echo @$po_value; ?></td>
                                  </tr><tr>
                                    <td width="34%">PO Type</td>
                                    <td width="66%"><?php echo @$po_type; ?></td>
                                  </tr>
								   <?php } ?>
								  <tr>
                                    <td width="34%">Project Closure Date</td>
                                    <td width="66%"><?php echo $exppaydate; ?></td>
                                  </tr>
								  <tr>
                                    <td width="34%">Zone</td>
                                    <td width="66%"><?php echo $zone; ?></td>
                                  </tr>
								  </table>
                            <br/>
                             <table width="100%" border="0" cellspacing="3" cellpadding="3" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:14px" >
