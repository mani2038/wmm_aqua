...
function next_link_model(ref,pulse)
{

		window.location.href='./?pulse='+pulse+'&ns=1';
}
...
{
	window.document.location="./?pulse="+puid;
...
function removeimageAction(action,pulse,image,id)
{
	
		if(window.confirm("Are you sure to remove image"))
		{
			window.document.location="./?pulse="+pulse+"&remove="+image+"&id="+id;
		}
		else
		{
			return false;
...
function removepromotionimage(action,pulse,type,id)
{
	
		if(window.confirm("Are you sure to remove image"))
		{
			window.document.location="./?pulse="+pulse+"&delimage="+type+"&id="+id;
		}
		else
		{
			return false;
