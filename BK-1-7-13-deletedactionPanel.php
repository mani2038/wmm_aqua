                        ...
                        <thead>
                            <tr>
                              ...
                              <th width="112">Event Date</th>
                                ...
                                <th width="129">Deleted By</th>
								 <th width="70">Type /<br/>Reason </th>
...
$SelQuery = "SELECT * FROM oxy2_actiondeleted  WHERE actionStatus = '4'";
...
if($cntt > 0){
				...
				$actionDeletionReason= $SelResult['leadDeletionReason'];
...
?>                         
                      ...
                      <a href="viewActionChartDateLine.php?actionId=<?php echo $actionChartId; ?>&leadNumber=<?php echo $leadNum; ?>" id="gallery_box" style="text-decoration:none; font-weight:bold; color:#666;">[<?php echo getTotalDateline($actionChartId,$leadNum);?>]</a>
						...
						<td align="center">
						 ...
						 <a class="tip_north" original-title="<?php echo $actionDeletionReason; ?>" href="#" style="color:#6C6C6C;padding:0 5px;"><b style="font-weight:bold;"><?php echo "<span class='red_highlight pj_cat'>".$reasonType."</span>"; ?></b></a>
						 
												 
						 </td>
                        <td align="center"><span class="data_actions iconsweet">
						<a class="tip_north" original-title="View" href="./?id=3&subId=12&actionChartId=<?php echo $actionChartId; ?> " style="color:#6C6C6C;padding:0 1px;font-size:18px;">}</a> 
						

<?php if($usernameforLoggedIn == "Amit.Kr@batessercon.com") { ?>   
                      
                     <a href="confirmActionRestorationPage.php?actionChartId=<?php echo $actionChartId; ?>" class="tip_north" id="gallery_box" original-title="Restore Action Chart" style="color:#F00;padding:0 1px;font-size:18px;">%</a>
