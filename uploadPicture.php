<!--One_Wrap-->
 	<div class="one_wrap fl_left">
    	<div class="widget">
        	...
        	<h5>Change Profile Picture</h5></div>
...
if($cnttForProfile > 0){
	  ...
	  <img src="phpThumb/phpThumb.php?src=../usr_thumb/<?php echo $name; ?>&amp;w=200&h=200&amp;zc=1&amp;fltr[]=ric|5|5&f=png&amp;hash=1967452c10c461eaf74689df4841c6dc" alt="" border="0" />
...
<strong>Your Current Picture</strong>   <br />
<br />
...
#########################################################################################################
$upload_dir = "usr_thumb"; 				// The directory for the images to be saved in
...
$thumb_image_db = $thumb_image_name.$_SESSION['user_file_ext'];
//Create the upload directory with the right permissions if it doesn't exist

//echo "$large_image_location--------------------------------------------------$thumb_image_location";
...
if (isset($_POST["upload"])) { 
	...
	if (strlen($error)==0){
		...
		if (isset($_FILES['image']['name'])){
			...
			//mysql_query($con,"UPDATE oxy2_uploadedimage SET name='$large_image_location' WHERE usr_Id='$userIdforAction'");
...
if (isset($_POST["upload_thumbnail"]) && strlen($large_photo_exists)>0) {
	...
	mysqli_query($con,"UPDATE oxy2_uploadedimage SET name='$thumb_image_db' WHERE usr_id='$emp' and area='1' ");
	...
	header("location:./?id=1&subId=1&error=2");
	exit();
}
...
if(strlen($error)>0){
	...
	echo "<div class='msgbar msg_Error hide_onC'><span class='iconsweet'>X</span><br />
<ul><li ><strong>Error!</strong></li><li>".$error."</li></ul></div>";
}
if(strlen($large_photo_exists)>0 && strlen($thumb_photo_exists)>0){
	...
	$_SESSION['user_file_ext']= "";
		...
		if(strlen($large_photo_exists)>0){?>
		<h3>Select image area to Create Thumbnail :</h3>
...
<input type="submit" name="upload_thumbnail" value="Save Thumbnail" id="save_thumb" style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:16px; color:#000000; font-weight:400; position: right;"/>
<br />
			</form>
			<br style="clear:both;"/>
	...
	<h5>Upload your profile picture : (2MB max)</h5>
