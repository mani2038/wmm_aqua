...
$SelQuery = "SELECT * FROM oxy2_lead2013";
...
?>                         
                    ...
                    <a href="viewLeadCon.php?ldId=<?php echo $lid; ?>" id="gallery_box" style="text-decoration:none; font-weight:bold;"><span class="data_actions iconsweet" style="font-size:18px; color:#333">H</span></a>                   
                     ...
                     <td align="center"><?php echo $creator."<br/>".$reg_time; ?></td>
                      <td align="center"><span class="data_actions iconsweet"><a class="tip_north" original-title="View" href="./?id=2&subId=26&ldnumber=<?php echo $leadno; ?>&dep=<?php echo $dept;?> " style="color:#6C6C6C;padding:0 2px;font-size:18px;">}</a> 
                      <!--<a class="tip_north" original-title="Edit Commercial Info" href="./?id=2&subId=15&ldId=<?php echo $lid; ?>"  style="color:#6C6C6C;padding:0 2px;font-size:18px;" target="_blank">C</a>
