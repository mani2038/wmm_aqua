...
$("#companyname").bind('keyup change', function() 
{ //if theres a change in the username textbox

var companyname = $("#companyname").val();//Get the value in the username textbox
	...
	var valid = pattern.test(companyname);
		...
		$.ajax({  //Make the Ajax Request
			type: "POST",  
			url: "ajax_check_clientName_retail.php",  //file name
		   ...
		   $("#availability_status").ajaxComplete(function(event, request){ 
			...
			$("#submit_status").html('<font color="red">Client already exist , please try with different name. </font>');
			}  
...
<!--One_Wrap-->
 	<div class="one_wrap fl_left">
    	<div class="widget">
        	...
        	<h5>Add New Client</h5></div>
            <div class="widget_body">
				<form  action="actionForClient_retail.php" method="post" name="form1"  onSubmit= "return check()" style="color: #818386;margin: 5px 0px 5px 25px;">

            <table width="879" border="0" align="center" cellpadding="0" cellspacing="0" id="applyCss">
                     
                      <tr>
                        <td height="24" valign="middle"> Client Listed </td>
                        ...
                        $att_id = $row['id'];
                        echo "<option value='$att_id'>$companyname</option>";
                        }                        
                        ?>
                      ...
                      <tr>
                        ...
                        <td valign="top"><div class="form_input"><input name="companyname" id="companyname"  type="text" class="tip_east" title="Client Name">
                      ...
                      <tr> 
                        ...
                        <td>
                        <div class="form_input"><input name="contact" id="contact"  type="text" class="tip_east" title="Contact Name"></div>
                        </td>
                        <td colspan="2"></td>
                      </tr>
