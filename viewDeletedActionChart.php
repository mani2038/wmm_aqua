...
$SelQuery = "SELECT * FROM oxy2_actiondeleted WHERE id = '$actionChartId'";
...
$SelExecForModal = mysql_query($SelQueryForModal);
if($cntt > 0){
				$i = 0;
				while($SelResultForModal = mysql_fetch_array($SelExecForModal))
				{
				$i++;
