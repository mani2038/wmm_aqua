...
$yearNumber = date('Y');
//$SelQuery = "SELECT * FROM oxy2_lead WHERE creatorid = '$userIdforAction' AND year(reg_time) = $yearNumber OR year(reg_time)='2018'";
$SelQuery = "SELECT * FROM oxy2_lead WHERE creatorid = '$userIdforAction'";
