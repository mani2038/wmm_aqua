...
if(function_exists('date_default_timezone_set')) date_default_timezone_set($timezone);
                        ...
                        $SelQuery1 = "SELECT * FROM oxy2_clientn ORDER BY id DESC";
                        $SelExec1 = mysqli_query($con,$SelQuery1);
                        
                        if(isset($_REQUEST["type"])){$type1=$_REQUEST["type"];}
						...
						$getPipelineGap = $getPipelineGap + getPipelineGap($type1,$clientId1,$systemMonthInDigit1);
...
<!--                            <a style="margin:5px;" class="whitishBtn button_small" href="#">Button White</a>
                            ...
                            <div align="right">
                            <a <?php if($_REQUEST['type'] == "p"){ ?>style="margin:5px; border:3px solid gray;"<?php } else {?>style="margin:5px;" <?php } ?> class="yellowBtn button_small" href="./?id=2&subId=16&type=p">Pessimistic Target</a> 
                             <a <?php if($_REQUEST['type'] == "r"){ ?>style="margin:5px; border:3px solid gray;"<?php } else {?>style="margin:5px;" <?php } ?> class="yellowBtn button_small" href="./?id=2&subId=16&type=r">Realistic Target</a>
                              <a <?php if($_REQUEST['type'] == "o"){ ?>style="margin:5px; border:3px solid gray;"<?php } else {?>style="margin:5px;" <?php } ?> class="yellowBtn button_small" href="./?id=2&subId=16&type=o">Optimistic Target</a>
