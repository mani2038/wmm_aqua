...
$SelQuery = "SELECT * FROM oxy2_lead ORDER BY leadno DESC";
...
?>                         
                     ...
                     <a href="viewLeadInvoice.php?ldId=<?php echo $lid; ?>" id="gallery_box" style="text-decoration:none; font-weight:bold;">[<?php echo getTotalInvoiceByLeadANDCompanyId($lid,$companyname); ?>]</a><br/>
                    ...
                    <a href="viewLeadCon.php?ldId=<?php echo $lid; ?>" id="gallery_box" style="text-decoration:none; font-weight:bold;"><span class="data_actions iconsweet" style="font-size:18px; color:#333">H</span></a>                   
                     ...
                     <td align="center"><?php echo $grand_amount_total; ?></td>
                     <td align="center"><?php echo $creator."<br/>".$reg_time; ?></td>
                      <td align="center"><span class="data_actions iconsweet"><a class="tip_north" original-title="View" href="./?id=2&subId=13&ldnumber=<?php echo $leadno; ?>&dep=<?php echo $dept;?> " style="color:#6C6C6C;font-size:18px;">}</a> <a class="tip_north" original-title="Edit Commercial Info" href="./?id=2&subId=15&ldId=<?php echo $lid; ?>"  style="color:#6C6C6C;font-size:18px;" target="_blank">C</a>
                      	<?php $PNLData = DownaloadPNL($leadno);
						if(!empty($PNLData)){ ?>
						<a class="tip_north" original-title="Download PNL" href="./uploadpnl/<?= $PNLData['pnlFileName'] ?>"  style="color:#6C6C6C;font-size:18px;" target="_blank"><i class="fa fa-download" aria-hidden="true"></i></a>
						<?php }
                      ?>
