...
<div class="one_wrap fl_left">
    <div class="widget">
        ...
        <div class="widget_body">
            <!--Form fields-->
            <form action="actionForActionChart.php" method="post" name="form1" id="form1" onSubmit="return check()">

                <ul class="form_fields_container">

                    <li>
                        <label>Aqua Lead number : *</label> 
                        <div class="form_input"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                                <tr>
                                    <td width="7%">Aqua </td>
                                    <td width="9%"><div style="position:relative; top:9px;margin-left:2px;margin-right:8px;"><select name="dept" id="dept_id" onChange="getinfo()">
                                                <option value=" ">Select Lead Number</option>
                                                <?php
                                                $que = "SELECT * FROM oxy2_lead order by leadno desc";
                                                $res = mysqli_query($con, $que);
                                                while ($row = mysqli_fetch_array($res)) {
                                                    $deptOfLead = $row['dept'];
                                                    $leadnoOfLead = $row['leadno'];
                                                    $com = $deptOfLead . "/" . $leadnoOfLead;
                                                    echo "<option value='$com'>$com</option>";
                                                }
                                                ?>

                                            </select></div> </td>
                                    <td width="84%" ><input name="leadno" type="text" class="tip_east" title="Number" style="display:none;"></td>
                                </tr>
                            </table>
...
//document.form1.keyact.disabled=false;
                    ...
                    <li ><label>Event Date :<br/></label> <div class="form_input"><input type="text" name="dateevent" id="datepicker" class="tip_east" title="Date"><span style="font-size:9px;">(Click 
                                to select Start date of Event)</span></div></li>

                                <li id="event_date" style="display:none;"><span style="font-size:14px; font-weight:bold;padding: 15px 27px;">For long drawn Multiple 
                            Day Activity </span></li>

                            <li id="event_date1" style="display:none;"><label>From :<br/><span style="font-size:9px;">(Start date of Event)</span></label> <div class="form_input"><input type="text" name="datefrom"  id="datepicker1" class="tip_east" title="From Date"></div></li>
                            <li id="event_date2" style="display:none;"><label>To :<br/><span style="font-size:9px;">(End date of Event)</span></label> <div class="form_input"><input type="text" name="dateto"  id="datepicker2" class="tip_east" title="To Date"></div></li>
		...
		var lead_id = $("#dept_id").val();
		 $.ajax({
            ...
            success: function(res){
				...
				$("#eventname").val(response.compnay_name);
