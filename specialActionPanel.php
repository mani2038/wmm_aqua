               ...
               <table cellpadding="0" cellspacing="0" border="0" class="display" id="jqtable">
                        <thead>
                            <tr>
                              ...
                              <th width="148">Campaign <br/>(Client)</th>
                              <th width="117">Event Date</th>
                                <th width="109">Venue/City</th>
                                <th width="146">Stage</th>
                                <th width="166">Status/<br/>Dateline</th>
                                <th width="132">Requested By</th>
                              <th width="107">Type /<br/>Reason </th>
...
$SelQuery = "SELECT * FROM oxy2_action WHERE actionStatus = '4'";
...
<a href="confirmActionDeletionPage.php?actionId=<?php echo $actionChartId; ?>" class="tip_north" id="gallery_box" original-title="Delete Action Chart" style="color:#F00;padding:0 1px;font-size:18px;">X</a>
